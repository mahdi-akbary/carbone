...
const GENERATOR_FOOTER = [
  '\n\\******************************************************************************/ '
];
const USAGE = GENERATOR_HEADER + [
  'Usage:',
  ...
  '',
  'Examples:',
  '   api-report-generator translate -l fr -p path/to/docs/directory',
].join('\n') + GENERATOR_FOOTER;
...
var translator = {
  ...
  handleCLI : function (args) {
    ...
    translator.generateLang(path.resolve(_dirpath), _lang, function (err, newObjLang, meta) {
      ...
      console.log([
        '\nThe api-report-generator lang file "'+ _lang +'.json" was successfully updated. Number of keys...',
