...
var preprocessor = {
  ...
  /**
   * [XLSX] Convert shared string to inline string in Excel format in order to be compatible with api-report-generator algorithm
   ...
   * api-report-generator Engine cannot update these counter itself
